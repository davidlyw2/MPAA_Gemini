...
# t8452
t8452_IN_BLOCK_CODE = ['shcode', 'ncnt', 'qrycnt', 'nday', 'sdate', 'stime', 'edate', 'etime', 'cts_date', 'cts_time', 'comp_yn', 'exchgubun']
t8452_IN_BLOCK_NAME = ['단축코드', '단위(n분)', '요청건수(최대-압축:2000비압축:500)', '조회영업일수(0:미사용1>=사용)', '시작일자', '시작시간(현재미사용)', '종료일자', '종료시간(현재미사용)', '연속일자', '연속시간', '압축여부(Y:압축N:비압축)', '거래소구분코드']
t8452_OUT_BLOCK_CODE = ['shcode', 'jisiga', 'jihigh', 'jilow', 'jiclose', 'jivolume', 'disiga', 'dihigh', 'dilow', 'diclose', 'highend', 'lowend', 'cts_date', 'cts_time', 's_time', 'e_time', 'dshmin', 'rec_count', 'nxt_fm_s_time', 'nxt_fm_e_time', 'nxt_fm_dshmin', 'nxt_am_s_time', 'nxt_am_e_time', 'nxt_am_dshmin']
t8452_OUT_BLOCK_NAME = ['단축코드', '전일시가', '전일고가', '전일저가', '전일종가', '전일거래량', '당일시가', '당일고가', '당일저가', '당일종가', '상한가', '하한가', '연속일자', '연속시간', '장시작시간(HHMMSS)', '장종료시간(HHMMSS)', '동시호가처리시간(MM:분)', '레코드카운트', 'NXT프리마켓장시작시간(HHMMSS)', 'NXT프리마켓장종료시간(HHMMSS)', 'NXT프리마켓동시호가처리시간(MM:분)', 'NXT에프터마켓장시작시간(HHMMSS)', 'NXT에프터마켓장종료시간(HHMMSS)', 'NXT에프터마켓동시호가처리시간(MM:분)']
t8452_OUT_BLOCK_1_CODE = ['date', 'time', 'open', 'high', 'low', 'close', 'jdiff_vol', 'value', 'jongchk', 'rate', 'sign']
t8452_OUT_BLOCK_1_NAME = ['날짜', '시간', '시가', '고가', '저가', '종가', '거래량', '거래대금', '수정구분', '수정비율', '종가등락구분(1:상한2:상승3:보합4:하한5:하락)']

# t8453
t8453_IN_BLOCK_CODE = ['shcode', 'ncnt', 'qrycnt', 'nday', 'sdate', 'stime', 'edate', 'etime', 'cts_date', 'cts_time', 'comp_yn', 'exchgubun']
t8453_IN_BLOCK_NAME = ['단축코드', '단위(n틱)', '요청건수(최대-압축:2000비압축:500)', '조회영업일수(0:미사용1>=사용)', '시작일자', '시작시간(현재미사용)', '종료일자', '종료시간(현재미사용)', '연속일자', '연속시간', '압축여부(Y:압축N:비압축)', '거래소구분코드']
t8453_OUT_BLOCK_CODE = ['shcode', 'jisiga', 'jihigh', 'jilow', 'jiclose', 'jivolume', 'disiga', 'dihigh', 'dilow', 'diclose', 'highend', 'lowend', 'cts_date', 'cts_time', 's_time', 'e_time', 'dshmin', 'rec_count', 'nxt_fm_s_time', 'nxt_fm_e_time', 'nxt_fm_dshmin', 'nxt_am_s_time', 'nxt_am_e_time', 'nxt_am_dshmin']
t8453_OUT_BLOCK_NAME = ['단축코드', '전일시가', '전일고가', '전일저가', '전일종가', '전일거래량', '당일시가', '당일고가', '당일저가', '당일종가', '상한가', '하한가', '연속일자', '연속시간', '장시작시간(HHMMSS)', '장종료시간(HHMMSS)', '동시호가처리시간(MM:분)', '레코드카운트', 'NXT프리마켓장시작시간(HHMMSS)', 'NXT프리마켓장종료시간(HHMMSS)', 'NXT프리마켓동시호가처리시간(MM:분)', 'NXT에프터마켓장시작시간(HHMMSS)', 'NXT에프터마켓장종료시간(HHMMSS)', 'NXT에프터마켓동시호가처리시간(MM:분)']
t8453_OUT_BLOCK_1_CODE = ['date', 'time', 'open', 'high', 'low', 'close', 'jdiff_vol', 'jongchk', 'rate', 'pricechk']
t8453_OUT_BLOCK_1_NAME = ['날짜', '시간', '시가', '고가', '저가', '종가', '거래량', '수정구분', '수정비율', '수정주가반영항목']

# t8454
t8454_IN_BLOCK_CODE = ['shcode', 'cvolume', 'starttime', 'endtime', 'cts_time', 'exchgubun']
t8454_IN_BLOCK_NAME = ['단축코드', '특이거래량', '시작시간', '종료시간', '시간CTS', '거래소구분코드']
t8454_OUT_BLOCK_CODE = ['cts_time', 'ex_shcode']
t8454_OUT_BLOCK_NAME = ['시간CTS', '거래소별단축코드']
t8454_OUT_BLOCK_1_CODE = ['chetime', 'price', 'sign', 'change', 'diff', 'cvolume', 'chdegree', 'volume', 'mdvolume', 'mdchecnt', 'msvolume', 'mschecnt', 'revolume', 'rechecnt', 'exchname']
t8454_OUT_BLOCK_1_NAME = ['시간', '현재가', '전일대비구분', '전일대비', '등락율', '체결수량', '체결강도', '거래량', '매도체결수량', '매도체결건수', '매수체결수량', '매수체결건수', '순체결량', '순체결건수', '거래소명']

# t9945
t9945_IN_BLOCK_CODE = ['gubun']
t9945_IN_BLOCK_NAME = ['구분(KSP:1KSD:2)']
t9945_OUT_BLOCK_CODE = ['hname', 'shcode', 'expcode', 'etfchk', 'nxt_chk', 'filler']
t9945_OUT_BLOCK_NAME = ['종목명', '단축코드', '확장코드', 'ETF구분', 'NXT상장구분', 'filler']
