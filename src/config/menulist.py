...
# 현물계좌 예수금/주문가능금액/총평가 조회 : CSPAQ12200
# CSPAQ12200_IN_BLOCK_CODE = ['RecCnt', 'MgmtBrnNo', 'AcntNo', 'Pwd', 'BalCreTp']
# CSPAQ12200_IN_BLOCK_NAME = ['레코드갯수', '관리지점번호', '계좌번호', '비밀번호', '잔고생성구분']
# CSPAQ12200_OUT_BLOCK_1_CODE = ['RecCnt', 'MgmtBrnNo', 'AcntNo', 'Pwd', 'BalCreTp']
# CSPAQ12200_OUT_BLOCK_1_NAME = ['레코드갯수', '관리지점번호', '계좌번호', '비밀번호', '잔고생성구분']
# CSPAQ12200_OUT_BLOCK_2_CODE = ['RecCnt', 'BrnNm', 'AcntNm', 'MnyOrdAbleAmt', 'MnyoutAbleAmt', 'SeOrdAbleAmt', 'KdqOrdAbleAmt', 'BalEvalAmt', 'RcvblAmt', 'DpsastTotamt', 'PnlRat', 'InvstOrgAmt', 'InvstPlAmt', 'CrdtPldgOrdAmt', 'Dps', 'SubstAmt', 'D1Dps', 'D2Dps', 'MnyrclAmt', 'MgnMny', 'MgnSubst', 'ChckAmt', 'SubstOrdAbleAmt', 'MgnRat100pctOrdAbleAmt', 'MgnRat35ordAbleAmt', 'MgnRat50ordAbleAmt', 'PrdaySellAdjstAmt', 'PrdayBuyAdjstAmt', 'CrdaySellAdjstAmt', 'CrdayBuyAdjstAmt', 'D1ovdRepayRqrdAmt', 'D2ovdRepayRqrdAmt', 'D1PrsmptWthdwAbleAmt', 'D2PrsmptWthdwAbleAmt', 'DpspdgLoanAmt', 'Imreq', 'MloanAmt', 'ChgAfPldgRat', 'OrgPldgAmt', 'SubPldgAmt', 'RqrdPldgAmt', 'OrgPdlckAmt', 'PdlckAmt', 'AddPldgMny', 'D1OrdAbleAmt', 'CrdtIntdltAmt', 'EtclndAmt', 'NtdayPrsmptCvrgAmt', 'OrgPldgSumAmt', 'CrdtOrdAbleAmt', 'SubPldgSumAmt', 'CrdtPldgAmtMny', 'CrdtPldgSubstAmt', 'AddCrdtPldgMny', 'CrdtPldgRuseAmt', 'AddCrdtPldgSubst', 'CslLoanAmtdt1', 'DpslRestrcAmt']
# CSPAQ12200_OUT_BLOCK_2_NAME = ['레코드갯수', '지점명', '계좌명', '현금주문가능금액', '출금가능금액', '거래소금액', '코스닥금액', '잔고평가금액', '미수금액', '예탁자산총액', '손익율', '투자원금', '투자손익금액', '신용담보주문금액', '예수금', '대용금 액', 'D1예수금', 'D2예수금', '현금미수금액', '증거금현금', '증거금대용', '수표금액', '대용주문가능금액', '증거금률100퍼센트주문가능금액', '증거금률35%주문가능금액', '증거금률50%주문가능금액', '전일매도정산금액', '전일매수정산금액', '금일매도정산금액', '금일매수정산금액', 'D1연체변제소요금액', 'D2연체변제소요금액', 'D1추정인출가능금액', 'D2추정인출가능금액', '예탁담보대출금액', '신용설정보증금', '융자금액', '변경후담보비율', '원담보금 액', '부담보금액', '소요담보금액', '원담보부족금액', '담보부족금액', '추가담보현금', 'D1주문가능금액', '신용이자미납금액', '기타대여금액', '익일추정반대매매금액', '원담보합계금액', '신용주문가능금액', '부담보합계금액', '신용담보금현금', '신용담보대용금액', '추가신용담보현금', '신용담보재사용금액', '추가신용담보대용', '매도대금담보대출금액', '처분제한금액']
